...
constraint pk_ResaFret  PRIMARY KEY (NumVol,DateVol,NumResa),
constraint fk1_ResaFret  FOREIGN KEY (NumVol,DateVol) references VolsPassager(NumVolP,DateVolP) ON DELETE CASCADE,
